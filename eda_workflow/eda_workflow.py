...
def make_eda_baseline_workflow(
    ...
    workflow.add_edge("profile_dataset", "validate_data_integrity")
    workflow.add_edge("validate_data_integrity", "extract_observations_1")
    workflow.add_edge("extract_observations_1", "analyze_missingness")
    workflow.add_edge("analyze_missingness", "extract_observations_2")
    workflow.add_edge("extract_observations_2", "detect_temporal_anomalies")
    workflow.add_edge("detect_temporal_anomalies", "extract_observations_3")
